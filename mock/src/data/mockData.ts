...
export const tasks: WbsTask[] = [
  ...
  },
  {
    ...
    parentId: null,
    name: "第3章 例外処理",
    description: "例外階層、try-catch、throwsを整理する親タスク。",
  ...
  },
  {
    ...
    parentId: "java-ch3",
    name: "例外の基本を読む",
    description: "チェック例外、非チェック例外、Errorを区別する。",
    plannedStartDate: "2026-06-13",
  ...
  },
  {
    ...
    projectId: "java-silver",
    parentId: "java-ch3",
    name: "try-catch-finallyを演習する",
    description: "finallyの実行順序と複数catchの条件を確認する。",
  ...
  },
  {
    ...
    projectId: "java-silver",
    parentId: "java-ch3",
    name: "throwsと例外伝播を確認する",
    description: "メソッド宣言と呼び出し側の扱いを問題で確認する。",
  ...
  },
  {
    ...
    parentId: null,
    name: "第4章 配列とコレクション",
    description: "配列、List、Set、Mapの基本を整理する親タスク。",
  ...
  },
  {
    ...
    parentId: "java-ch4",
    name: "配列と拡張for文を確認する",
    description: "配列生成、初期化、参照の扱いを復習する。",
    plannedStartDate: "2026-06-21",
  ...
  },
  {
    ...
    parentId: "java-ch4",
    name: "ListとSetの問題を解く",
    description: "ArrayList、HashSet、重複、順序の違いを確認する。",
  ...
  },
  {
    ...
    parentId: "java-ch4",
    name: "MapとAPI問題を復習する",
    description: "キーと値、put/get、代表的なAPIを整理する。",
  ...
  },
  {
    ...
    parentId: null,
    name: "第5章 ラムダ式とAPI",
    description: "ラムダ式、関数型インターフェース、Streamの親タスク。",
  ...
  {
    id: "java-ch5-functional",
    projectId: "java-silver",
    parentId: "java-ch5",
    name: "関数型インターフェースを演習する",
    description: "Predicate、Function、Consumer、Supplierを整理する。",
  ...
  },
  {
    ...
    projectId: "java-silver",
    parentId: "java-ch5",
    name: "Stream APIの問題を解く",
    description: "filter、map、forEach、終端操作を確認する。",
  ...
  {
    id: "java-review-mistakes",
    projectId: "java-silver",
    parentId: "java-review",
    name: "間違えた問題を解き直す",
    description: "章末問題と模擬問題の誤答を再確認する。",
    plannedStartDate: "2026-07-09",
  ...
  {
    id: "java-review-final",
    projectId: "java-silver",
    parentId: "java-review",
    name: "直前確認リストを作る",
    description: "試験前日に見るチェックリストを作成する。",
