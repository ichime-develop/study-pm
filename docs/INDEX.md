...
5. [詳細設計README](detailed-design/README.md)、[DBスキーマ詳細設計](detailed-design/database-schema.md)、[業務ロジック詳細設計](detailed-design/business-logic.md)、[進捗分析API詳細設計](detailed-design/analysis-api.md)、[AI学習計画API詳細設計](detailed-design/ai-plan-api.md)、[AI学習計画生成詳細設計](detailed-design/ai-plan-generation.md)、[実装方針詳細設計](detailed-design/implementation-policy.md)で実装前提を具体化する。
6. [UIモック](ui-mock/README.md)、[MVP3 AI作成画面計画](ui-mock/mvp3-screen-plan.md)、[開発方針](development/README.md)、[WBS生成品質の評価方針](development/wbs-generation-evaluation.md)を参照し、実装・評価方針に落とし込む。
...
- [WBS生成品質の評価方針](development/wbs-generation-evaluation.md) - AIとサーバーロジックを含むWBS生成品質、安定性、性能、費用の比較方法を定義する。
